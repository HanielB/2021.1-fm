...
- A simple family model with facts, different run configurations *and assertions* for the Alloy Analyzer: [family-2.als]({{ site.baseurl }}{% link _lessons/03-alloy-intro/code/family-4.als %})
